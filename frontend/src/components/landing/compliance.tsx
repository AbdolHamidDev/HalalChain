          ...
          {items.map((item) => {
            ...
            return (
              <AnimateItem key={item.titleKey}>
                <Card className="group relative overflow-hidden border-border/40 hover:border-border/80 transition-all duration-500 hover:shadow-xl bg-background/50 backdrop-blur-sm h-full">
                  <div
                  ...
                  <CardContent className="relative p-6 space-y-4">
                    <div className={`flex items-center justify-center w-11 h-11 rounded-xl ${item.accent}/10 group-hover:scale-110 transition-all duration-300`}>
