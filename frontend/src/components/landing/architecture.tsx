...
const mainStack = [
  { icon: Globe, label: "Next.js", subtitle: "Frontend & SSR", color: "from-primary/20 to-primary/5", iconColor: "text-primary" },
  { icon: Server, label: "Express API", subtitle: "RESTful backend", color: "from-emerald-500/20 to-emerald-500/5", iconColor: "text-emerald-500" },
  { icon: Database, label: "Prisma ORM", subtitle: "Type-safe queries", color: "from-amber-500/20 to-amber-500/5", iconColor: "text-amber-500" },
  { icon: Database, label: "PostgreSQL", subtitle: "Relational database", color: "from-sky-500/20 to-sky-500/5", iconColor: "text-sky-500" },
];
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {externalServices.map((service) => {
              ...
              return (
                <Card key={service.label} className="border-border/40 bg-background/80 backdrop-blur-sm hover:shadow-md transition-all duration-300">
                  <CardContent className="p-5 flex items-center gap-4">
