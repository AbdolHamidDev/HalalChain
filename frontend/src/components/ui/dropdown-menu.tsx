...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ...
    className={cn(
      ...
      "bg-popover/95 backdrop-blur-md p-1 text-popover-foreground",
...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[13rem] overflow-hidden rounded-xl border",
        "bg-popover/95 backdrop-blur-md p-1 text-popover-foreground",
        "shadow-xl shadow-black/10",
        "data-[state=open]:animate-in data-[state=closed]:animate-out",
        "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      "[&_svg]:size-4 [&_svg]:shrink-0 text-foreground/90",
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ...
    className={cn(
      ...
      "transition-all duration-150",
      "hover:bg-accent/70 focus:bg-accent",
      "data-[disabled]:pointer-events-none data-[disabled]:opacity-40",
      className
    )}
    {...props}
  >
    <span className="absolute left-2 flex h-4 w-4 items-center justify-center rounded-sm border border-muted-foreground/30">
