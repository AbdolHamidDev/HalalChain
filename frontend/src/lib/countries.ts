 ...
 * Uses ISO 3166-1 alpha-2 codes for flag emoji generation.
 * Names follow standard international naming conventions.
 */
...
/**
 * Search countries by name (case-insensitive, accent-insensitive).
 */
